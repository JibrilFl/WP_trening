...
?>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><?php the_field('aboutus__title'); ?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('aboutus__subtitle_one'); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('aboutus__descr_one'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" 
                            <?php
                                $image = get_field('aboutus__img_one');
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" 
                            <?php
                                $image = get_field('aboutus__img_two');
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('aboutus__subtitle_two'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('aboutus__descr_two'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('aboutus__subtitle_tree'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('aboutus__descr_tree'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img"
                            <?php
                                $image = get_field('aboutus__img_tree');
...
<?php
    ...
    // do_action( 'my_hook', 'dear customer', 'Sashka' );
    ...
    // echo apply_filters( 'my_filter', 'World' ); Избавляемся от хука фильтра

    // remove_action ----- Так же избавляемся от хука но только у события

    // Следует разделять хуки событий и фильтров
?>
<?php
    get_footer();
?>
